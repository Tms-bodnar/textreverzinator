 ...
 *  majd egy kiolvasóval kiolvassuk a privát written osztály written tagfüggvényéből.
 * A kiolvasott stringet char sorrá alakítjuk
 * char sorrá alakítjuk, majd kiírjuk
 *
 * @author bodnart
 */
public class start {
    ...
    if (varied < 0){
      ...
      System.out.println(", Jó mi?") ;// Kiírjuk az eredményt, majd újraindítjuk a kérdést.
